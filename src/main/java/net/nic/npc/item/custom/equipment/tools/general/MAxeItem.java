...
public class MAxeItem extends MTool {
    ...
    public MAxeItem(ResourceLocation name, Properties properties, ToolMaterial material, float attackDamage, float attackSpeed) {
        super(name, properties.axe(material,attackDamage,attackSpeed));
        toolMat = material;
    }
