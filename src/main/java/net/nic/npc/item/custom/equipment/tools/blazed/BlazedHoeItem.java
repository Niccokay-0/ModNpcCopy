...
import net.nic.npc.item.custom.equipment.tools.general.MHoeItem;
import net.nic.npc.item.materials.CustomMaterials;

public class BlazedHoeItem extends MHoeItem {


    public BlazedHoeItem(ResourceLocation name, Properties properties, ToolMaterial material, float attackDamage, float attackSpeed) {
    ...
    public boolean mineBlock(ItemStack stack, Level level, BlockState state, BlockPos pos, LivingEntity miningEntity) {
        if (state.is(CustomBlockTags.NETHER_TREE_FOLIAGE)) {
